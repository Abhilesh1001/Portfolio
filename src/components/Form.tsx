...
const Form = () => {
  ...
  return (
    ...
    <div className="mb-1">
      ...
      <input type="text" id="name" className="borde text-gray-700 border-gray-300  px-3 py-1 rounded-md w-full focus:outline-none focus:border-blue-500" name='name' />
    </div>
    <div className="mb-1">
      <label htmlFor="email" className="block dark:text-gray-50 font-bold">Email</label>
      <input type="email" id="email" className="border border-gray-300 text-gray-700 rounded-md px-3 py-1 text-sm w-full focus:outline-none focus:border-blue-500" name='email' />
    </div>
    <div className="mb-1">
      <label htmlFor="message" className="block dark:text-gray-50 font-bold mb-2">Message</label>
      <textarea id="message" className="border text-gray-700 border-gray-300 rounded-md px-3 py-2 w-full h-20 resize-none focus:outline-none focus:border-blue-500" name='message' />
    </div>
